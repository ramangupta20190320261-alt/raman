...
function showTheCards(){
    ...
    arr.forEach(function(obj){
        clutter += `<div class="box w-40">
    <img class="cursor-pointer w-full h-28 object-cover rounded-md" src="${obj.image}" alt="image">
    <div class="caption text-sm mt-2"> ${obj.name} </div>
</div>`;
